...
|--------------|-------------|
| `Feel-Good Hits` | High energy, high valence — perfect for upbeat moods |
| `Chill & Acoustic` | Low energy, high acousticness — calm and emotional |
| `Angry / Intense` | High energy, low valence — aggressive and fast |
| `Balanced / Versatile Mix` | Medium values across features — versatile listening |
